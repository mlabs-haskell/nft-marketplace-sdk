 ...
 */
export const makeBidAuctionTransaction = (baseURL: string, contractInstanceId: string) =>
 ...
 */
export const makeCloseAuctionTransaction = (baseURL: string, contractInstanceId: string) =>
 ...
 */
export const makeOpenAuctionTransaction = (baseURL: string, contractInstanceId: string) =>
